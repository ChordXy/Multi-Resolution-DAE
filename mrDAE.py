...
LastEditors: Cabrite
LastEditTime: 2020-08-23 09:00:51
...
def ParseInputs():
    ...
    flag_parser.add_argument('--sync', dest='LackOfMemory', action='store_true')
    flag_parser.add_argument('--no-sync', dest='LackOfMemory', action='store_false')
    flag_parser.set_defaults(LackOfMemory=True)
...
def Build_Networks(args):
    ...
    mrDAE.set_TiedAE_Training_Parameters(epochs=475, lr_init=2e-1, lr_decay_step=4, lr_decay_rate=0.98)
